...
# sys.path.append(r"/home/shared/wrf/siam-mot/siammot/configs")
...
from siammot.modelling.siam_mot_u import build_siammot as build_siammot_modified
...
def train(cfg, train_dir, local_rank, distributed, logger, modified):

    # build model
    if modified:
        model = build_siammot_modified(cfg)
    else:
...
def main():
    ...
    train(cfg, train_dir, args.local_rank, args.distributed, logger, args.modified)
