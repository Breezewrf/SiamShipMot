...
cfg.MODEL.DLA.STAGE_WITH_DCN = (True, True, True, True, True, True)
...
cfg.SOLVER.VIDEO_CLIPS_PER_BATCH = 1
...
# extra checkpoint
cfg.MODEL.WEIGHT = './pretrained/frcnn_dla34.pth'
# cfg.MODEL.WEIGHT = './pretrained/u2netp.pth'
